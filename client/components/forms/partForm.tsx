...
const formSchema = z.object({
  ...
  name: z.string().min(1),
  partType: z.array(z.string()).min(1),
  brand: z.string().min(1),
  quantityInStock: z.number(),
  price: z.string().min(1),
  status: z.array(z.enum(["In Stock", "Out of Stock"])).min(1),
})
...
export function PartForm({ open, onOpenChange, onSubmit, initialValues }: PartFormProps) {
      ...
      <Form {...form}>
        ...
        >
          ...
          <Button type="submit" className="w-full">
            {initialValues ? "Update Part" : "Create Part"}
          </Button>
        </form>
      </Form>
    </DialogContent>
