...
router.get("/primaryjobcard", (req, res) =>
  JobController.primaryJobCard(req, res)
);
router.get("/secondaryjobcard", (req, res) =>
  JobController.secondaryJobCard(req, res)
);
router.get("/jobdescription", (req, res) =>
  JobController.jobDescription(req, res)
);
